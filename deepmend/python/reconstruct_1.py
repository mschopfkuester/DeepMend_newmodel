...
def reconstruct(
    ...
    tb_logger = torch.utils.tensorboard.writer.SummaryWriter(log_dir="logger_Reconstruction")
    ...
    for e in range(num_iterations):
        ...
        if lambda_ner != 0.0:
            ...
            print(ner_loss,-lambda_ner*torch.log(r_x.mean(axis=0)))
            loss = loss + ner_loss
        ...
        tb_logger.add_scalar("Mean Reconstruction Shape", (r_x.mean()).item(), e)
