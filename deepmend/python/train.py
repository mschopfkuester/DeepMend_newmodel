...
def main_function(experiment_directory, continue_from, batch_split,train_split_path=None,data_source_path=None, save_model_end_index=0):
    ...
    for epoch in tqdm.tqdm(
        ...
        #adjust_learning_rate_new(optimizer_all, 0.1,50,0.005,epoch, num_epochs)
        ...
        for data, inds in sdf_loader:
            ...
            for i in range(batch_split):
                ...
                #tb_logger.add_scalar("complete_loss", complete_loss.item(), epoch)
                #if (epoch-1)==0:
                    #factor=1
                #if epoch%200==0:
                #    factor=factor-0.1
                ...
                if lambda_ner != 0.0:
                    ner_loss=(r_gt.mean()/r_x.mean()-1)**2
                    loss+= lambda_ner*ner_loss
